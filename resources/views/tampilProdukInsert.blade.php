...
<body style="background-color: grey">
    ...
    <form method="post" action="/produk/save">
        ...
        <table class="table table-borderless table-dark" style="width: auto" align="center">
            <tr><td align="right">Kode Produk</td><td><input type="text" name="kode" required></td></tr>
            <tr><td align="right">Nama Produk</td><td><input type="text" name="nama" required></td></tr>
